        ...
        <div className="card__details">
            ...
            <div className="card__details__bottom">
                                    ...
                                    if(index < 4){
                                        return (
                                            <div className="stack__box">
                                                <div className="stack__icon__container" style={{color:list.iconColor}}>
                        ...
                        </div>{/* end stack__box__container */}
                        {
                            props.stack.length >4 ?(
                                <div className="stack__view__more">
                                    <div className="more__btn" onClick={() => setOpenStackExpandBar(!openStackExpandBar)}>See More</div>
                ...
                <div className="button__container">
                    <a href={props.data.demoLink} target='__blank' className='btn btn__primary'>Demo</a>
